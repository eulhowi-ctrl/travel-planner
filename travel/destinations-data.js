...
const COUNTRY_SEEDS = [
    { country: '대한민국', emoji: '🇰🇷', region: 'asia', cities: [
        ...
        // 광역시/특별자치시
        ['인천', 37.4563, 126.7052], ['대구', 35.8714, 128.6014], ['대전', 36.3504, 127.3845],
        ['광주', 35.1595, 126.8526], ['울산', 35.5384, 129.3114], ['세종', 36.4800, 127.2890],
        // 경기/인천권
        ['수원', 37.2636, 127.0286], ['용인', 37.2411, 127.1776], ['가평', 37.8315, 127.5095],
        ['양평', 37.4917, 127.4874], ['파주', 37.8154, 126.7936], ['남양주', 37.6360, 127.2165],
        ['포천', 37.8949, 127.2003], ['이천', 37.2724, 127.4350], ['여주', 37.2983, 127.6376],
        ['안산', 37.3219, 126.8309], ['강화도', 37.7466, 126.4874], ['을왕리', 37.4459, 126.3727],
        ['김포', 37.6152, 126.7157], ['동두천', 37.9036, 127.0606], ['연천', 38.0966, 127.0749],
        ['부천', 37.5035, 126.7660], ['하남', 37.5393, 127.2148], ['광명', 37.4780, 126.8646],
        ['시흥', 37.3799, 126.8030], ['의왕', 37.3448, 126.9683], ['과천', 37.4292, 126.9876],
        ['안양', 37.3943, 126.9568], ['군포', 37.3617, 126.9351], ['오산', 37.1499, 127.0772],
        ['평택', 36.9922, 127.1128], ['화성', 37.1996, 126.6489],
        // 강원권
        ['춘천', 37.8813, 127.7298], ['원주', 37.3422, 127.9202], ['동해', 37.5247, 129.1143],
        ['삼척', 37.4500, 129.1655], ['정선', 37.3806, 128.6608], ['평창', 37.3705, 128.3902],
        ['태백', 37.1641, 128.9856], ['홍천', 37.6971, 127.8887], ['양양', 38.0755, 128.6191],
        ['고성강원', 38.3806, 128.4680],
        // 충청권
        ['청주', 36.6424, 127.4890], ['충주', 36.9910, 127.9259], ['제천', 37.1326, 128.1909],
        ['단양', 36.9846, 128.3656], ['보은', 36.4894, 127.7295], ['영동', 36.1750, 127.7834],
        ['천안', 36.8151, 127.1139], ['아산', 36.7898, 127.0018], ['공주', 36.4465, 127.1189],
        ['부여', 36.2757, 126.9099], ['서산', 36.7848, 126.4503], ['태안', 36.7455, 126.2977],
        ['보령', 36.3332, 126.6128], ['논산', 36.1872, 127.0989], ['예산', 36.6809, 126.8452],
        ['당진', 36.8930, 126.6291],
        // 전라권
        ['군산', 35.9676, 126.7369], ['익산', 35.9483, 126.9575], ['남원', 35.4164, 127.3908],
        ['순창', 35.3745, 127.1374], ['고창', 35.4351, 126.7016], ['부안', 35.7318, 126.7333],
        ['무주', 36.0069, 127.6608], ['진안', 35.7917, 127.4247], ['목포', 34.8118, 126.3922],
        ['순천', 34.9506, 127.4872], ['담양', 35.3213, 126.9882], ['보성', 34.7714, 127.0800],
        ['화순', 35.0645, 126.9862], ['완도', 34.3111, 126.7550], ['진도', 34.4867, 126.2634],
        ['해남', 34.5732, 126.5992], ['광양', 34.9406, 127.6958], ['구례', 35.2024, 127.4629],
        ['영광', 35.2770, 126.5119],
        // 경상권
        ['포항', 36.0190, 129.3435], ['안동', 36.5684, 128.7294], ['영주', 36.8056, 128.6239],
        ['문경', 36.5867, 128.1868], ['울진', 36.9930, 129.4003], ['영덕', 36.4155, 129.3657],
        ['청도', 35.6474, 128.7340], ['경산', 35.8251, 128.7414], ['창원', 35.2280, 128.6811],
        ['진주', 35.1800, 128.1076], ['김해', 35.2285, 128.8894], ['거제', 34.8806, 128.6210],
        ['하동', 35.0670, 127.7513], ['남해', 34.8050, 127.8890], ['밀양', 35.5038, 128.7466],
        ['양산', 35.3350, 129.0378], ['산청', 35.4159, 127.8737], ['함양', 35.5203, 127.7253],
        // 제주 세부지역
        ['성산', 33.4582, 126.9426], ['애월', 33.4630, 126.3306], ['우도', 33.5052, 126.9520],
        ['협재', 33.3939, 126.2394], ['서귀포', 33.2541, 126.5601],
    ]},
...
// Jeju-island city names (제주도 itself plus its named sub-areas added later)
// that need flight, not KTX/intercity bus, since they're only reachable by
// air/ferry from the mainland — used wherever code branches on "is this
// domestic-by-land or does it need a flight" (itinerary.html, search.html).
const JEJU_CITIES = ['제주도', '성산', '애월', '우도', '협재', '서귀포'];
...
const AIRPORT_CODES = {
    ...
    '성산': 'CJU', '애월': 'CJU', '우도': 'CJU', '협재': 'CJU', '서귀포': 'CJU',
    // 일본
